                        ...
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    {/* <a id='sewa-mobil' class="btn btn-primary btn-lg px-4 me-sm-3" href="#sewa">Mulai Sewa Mobil</a> */}
                                    <Button />
                                </div>
                            </div>
                        </div>
...
function Button() {
    ...
    let url="/cari_mobil";
    let element=<Link id='sewa-mobil' class="btn btn-primary btn-lg px-4 me-sm-3" to={url}>Mulai Sewa Mobil</Link>;
    return(
        <>
        {state && element}
        </>
