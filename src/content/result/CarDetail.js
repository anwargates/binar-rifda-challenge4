                ...
                <div className='row'>
                    <div className='col-12 col-sm-8 col-lg-8'>
                        ...
                        <div className="d-flex justify-content-end my-3">
                            <button id='btn-card' className='btn my-2 my-sm-0 text-light color-btn-green'>Lanjutkan Pembayaran</button>
                        </div>
                    </div>
                    <div className='col-12 col-sm-4 col-lg-4'>
                        <div className='card card-car xm-1 p-2'>
                            ...
                            <div className="card-body">
                                ...
                                <button id='btn-card' className='form-control btn my-2 my-sm-0 text-light color-btn-green'>Lanjutkan Pembayaran</button>
                            </div>
                        </div>
                    </div>
                </div>
